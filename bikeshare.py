...
def get_filters():
    ...
    print("Type end at any time if you would like to exit the program.\n")
        ...
        # get user input for city (chicago, new york city, washington). HINT: Use a while loop to handle invalid inputs get user input for month (all, january, february, ... , june), get user input for day of week (all, monday, tuesday, ... sunday)
